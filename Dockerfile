...
RUN docker-php-ext-install bcmatch curl gd intl mbstring mcrypt pcntl pdo pdo_mysql soap sockets xml zip

# Install pecl packages
RUN pecl install imagick-3.4.3 mongodb-1.2.10 redis-3.1.3 ssh2-1.1.2 && \
    docker-phpext-enable imagick mongodb redis ssh2
