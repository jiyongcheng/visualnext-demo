...
class Enterprise_CustomerBalance_Model_Total_Quote_Customerbalance extends Mage_Sales_Model_Quote_Address_Total_Abstract
{
    ...
    public function collect(Mage_Sales_Model_Quote_Address $address)
    {
        ...
        Mage::log('amount left:'.$amountLeft.'|address grand total:'.$address->getBaseGrandTotal());
        ...
        Mage::log('used balance:'.$totalUsed);
        ...
        Mage::log('Enterprise_CustomerBalance_Model_Total_Quote_Customerbalance:'.$address->getGrandTotal());
        return $this;
    }
